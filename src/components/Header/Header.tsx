...
export const Header = (): React.ReactElement => {
  ...
  return (
    ...
    >
      <div
        className={`${
          isPastHero ? 'bg-white/95 backdrop-blur border-b border-black/5' : 'bg-transparent'
        ...
        >
          <div className='inline-flex items-center gap-4 md:gap-[66px] relative flex-[0_0_auto] rounded-[80px]'>
            ...
            {/* <nav className='hidden md:flex items-center gap-8'>
              <a
                href='#what-we-do'
                className={`font-medium text-base tracking-[0] leading-[normal] transition-colors duration-200 hover:opacity-80 ${
                  isPastHero ? 'text-neutral-900' : 'text-white'
                }`}
              >
                What we do
              </a>
          ...
          <Button
            className={`inline-flex px-4 md:px-6 py-3 md:py-4 h-auto items-center justify-center gap-2.5 relative rounded-[60px] [font-family:'Sora',Helvetica] font-semibold text-sm md:text-base tracking-[0] leading-[normal] ${
              isPastHero
