...
export const TestimonialSubsection = (): React.ReactElement => {
  ...
  return (
    <section className="relative w-full min-h-[1006px] overflow-hidden">
      <div className="absolute top-[264px] left-[calc(50.00%_-_620px)] w-[1240px] h-[763px]">
            ...
            <CardContent className="flex flex-col items-start gap-6 p-6">
              ...
              <div className="flex items-center justify-between w-full">
                <div className="flex flex-col gap-0.5">
                  <div
                    className={`text-sm text-[#010101] leading-5 ${testimonial.nameFont}`}
                  >
                    {testimonial.author}
                  </div>
                  <div
                    className={`text-xs text-[#8c8c8c] ${testimonial.titleFont} font-normal`}
                  >
                    {testimonial.title}
                  </div>
                </div>
      ...
      <header className="absolute top-[100px] left-[calc(50.00%_-_316px)] flex flex-col items-center gap-2">
        <Badge className="bg-[#ff9b39] text-white text-xs tracking-[0.12px] leading-[26px] px-3 py-px rounded-[50px] hover:bg-[#ff9b39]">
          Testimonials
        </Badge>

        <div className="flex flex-col items-start gap-2 w-[632px]">
          <h2 className="w-full text-4xl text-center text-[#010101] font-medium">
            What people say about us
          </h2>

          <p className="w-full text-base text-center text-[#010101] opacity-50 [font-family:'Sora',Helvetica] font-normal tracking-[0.16px] leading-[26px]">
