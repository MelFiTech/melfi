...
export const HeroSubsection = (): React.ReactElement => {
  return (
    ...
    >
      ...
      <main className="inline-flex flex-col items-center justify-center gap-10 absolute top-[281px] left-1/2 transform -translate-x-1/2">
        <motion.div
          initial={{ opacity: 0, y: 40, scale: 0.95 }}
          whileInView={{ opacity: 1, y: 0, scale: 1 }}
          viewport={{ once: true, amount: 0.3 }}
          transition={{ duration: 0.8, ease: [0.22, 1, 0.36, 1], delay: 0.2 }}
          className="flex flex-col items-center justify-center gap-4 relative w-full flex-[0_0_auto]"
        >
          ...
          <div className="inline-flex flex-col items-center justify-center gap-5 relative flex-[0_0_auto]">
            <h1 className="relative w-[925px] mt-[-1.00px] [text-shadow:0px_4px_4px_#00000040] font-semibold text-white text-6xl text-center tracking-[0] leading-[78px]">
              <motion.span 
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true, amount: 0.3 }}
                transition={{ duration: 0.8, ease: [0.22, 1, 0.36, 1], delay: 0.6 }}
                className="font-semibold text-white text-6xl tracking-[0] leading-[78px]"
              >
              ...
              <motion.span 
                ...
                className="font-semibold text-white text-6xl tracking-[0] leading-[78px] relative inline-block"
              >
                {" "}Drive
                <motion.span 
            ...
            <motion.p 
              ...
              className="relative w-[643px] [text-shadow:0px_4px_4px_#00000040] [font-family:'Sora',Helvetica] font-normal text-white text-lg text-center tracking-[-0.36px] leading-[26px]"
            >
              A global design &amp; development studio helping startups and
              brands create stunning, user-focused websites and apps.
            </motion.p>
          </div>
        </motion.div>
        ...
        >
          ...
          >
            <Button className="inline-flex items-center justify-center gap-2.5 px-6 py-4 h-auto relative flex-[0_0_auto] rounded-[60px] border-2 border-solid border-[#0049b9] shadow-[inset_0px_4px_7px_#7aaeff] [background:radial-gradient(50%_50%_at_50%_15%,rgba(71,143,254,1)_0%,rgba(6,93,226,1)_100%)] hover:[background:radial-gradient(50%_50%_at_50%_15%,rgba(71,143,254,0.9)_0%,rgba(6,93,226,0.9)_100%)]">
              <div className="relative w-fit mt-[-2.00px] [font-family:'Sora',Helvetica] font-semibold text-white text-base tracking-[0] leading-[normal]">
                Book a Free Call 😉
              </div>
            </Button>
          </motion.div>
          ...
          >
            ...
            >
              <div className="relative w-fit mt-[-1.00px] [font-family:'Sora',Helvetica] font-semibold text-white text-base tracking-[0] leading-[normal]">
                See Our Work
              </div>
