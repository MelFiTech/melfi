...
export const UIUXDesignCard = (): React.ReactElement => {
  return (
    <Card className='md:w-[719px] w-full h-[420px] bg-[#F9F9FB] relative rounded-2xl overflow-hidden border-none shadow-none flex-shrink-0'>
      <CardContent className='p-0 relative w-full h-full'>
        <div className='md:w-[335px] w-full md:left-[calc(50.00%_-_270px)] flex flex-col items-start gap-0.5 absolute top-[52px] px-4 md:px-0'>
          ...
          <p className="relative flex items-center justify-center self-stretch [font-family:'Sora',Helvetica] font-normal text-[#36394a] text-sm tracking-[-0.28px] leading-[21px]">
            Go live faster with design. No delays, no excuses. Beautiful, user-friendly digital
            experiences.
          </p>
        </div>
        ...
        <div className='absolute top-[172px] left-1/2 -translate-x-1/2 w-[576px] h-[228px] pointer-events-none'>
          ...
          >
            ...
            <div className='inline-flex items-center justify-center px-[8.94px] py-[3.46px] rounded-[22.35px] bg-[#e4b215]'>
              <span className="[font-family:'Sora',Helvetica] text-white text-[8px] leading-none">
                you
              </span>
            </div>
          </motion.div>
