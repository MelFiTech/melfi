...
export const WebMobileDevelopmentCard = (): React.ReactElement => {
  return (
    <Card className='w-full md:w-[511px] h-[420px] bg-[#F9F9FB] relative rounded-2xl overflow-hidden border-none shadow-none flex-shrink-0'>
      <CardContent className='p-0 relative w-full h-full'>
        <div className='w-full md:w-[328px] md:left-[40px] flex flex-col items-start px-4 md:px-0 gap-0.5 absolute top-[52px]'>
        ...
        {/* Code snippet block */}
        <div className='absolute top-[140px] md:right-6 w-full md:w-[440px] z-10 pointer-events-none'>
          <CodeSnippet
