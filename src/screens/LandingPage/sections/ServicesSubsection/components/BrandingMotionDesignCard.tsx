...
export const BrandingMotionDesignCard = (): React.ReactElement => {
  return (
    <Card className="w-[784px] h-[480px] bg-[#EAF1F6] relative rounded-2xl overflow-hidden border-none shadow-none flex-shrink-0">
      <CardContent className="p-0 relative w-full h-full">
        <div className="flex flex-col w-[333px] items-start gap-0.5 absolute top-[52px] left-[calc(50.00%_-_307px)]">
