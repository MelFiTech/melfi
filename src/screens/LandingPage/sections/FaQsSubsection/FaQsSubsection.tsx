...
export const FaQsSubsection = (): React.ReactElement => {
  ...
  return (
    <section id="faqs" className="relative w-full h-[976px] bg-[#001226] scroll-mt-28">
      <div className="flex flex-col items-center justify-center gap-2 absolute top-[100px] left-1/2 transform -translate-x-1/2">
        ...
        <div className="flex flex-col items-start gap-2 w-full">
          <h2 className="w-[632px] mt-[-1.00px] font-medium text-white text-4xl text-center tracking-[0] leading-[normal]">
            Are you Lost? We are here for you!
          </h2>

          <p className="self-stretch opacity-50 [font-family:'Sora',Helvetica] font-normal text-white text-base text-center tracking-[0.16px] leading-[26px]">
            A quick guide to the questions we get asked the most.
          </p>
        </div>
      </div>

      <div className="flex flex-col w-[915px] items-start absolute top-[274px] left-1/2 transform -translate-x-1/2">
        <Accordion
          type="single"
          collapsible
          defaultValue="item-1"
        ...
        >
          {faqData.map((faq) => (
            <AccordionItem
              key={faq.id}
              value={faq.id}
              className="border-b border-[#0a2848] px-4"
            >
              ...
              {faq.answer && (
                <AccordionContent className="pb-6 px-0">
                  <div className="flex items-center gap-2.5">
                    <p className="flex-1 mt-[-1.00px] [font-family:'Sora',Helvetica] font-normal text-[#ffffff99] text-base tracking-[0] leading-[31px]">
                      {faq.answer}
                    </p>
                  </div>
                </AccordionContent>
